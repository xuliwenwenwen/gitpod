...
func (g *Guard) setLabel(label string, add bool) error {
	return retry.RetryOnConflict(retry.DefaultBackoff, func() error {
		node, err := g.Clientset.CoreV1().Nodes().Get(context.Background(), g.Nodename, metav1.GetOptions{})
		if err != nil {
			return err
		}
		...
		_, err = g.Clientset.CoreV1().Nodes().Update(context.Background(), node, metav1.UpdateOptions{})
		if err != nil {
			return err
		}
