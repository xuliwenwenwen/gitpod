...
func GetIntegrationTestClient(kubecfgfn string) (client kubernetes.Interface, namespace string, err error) {
	...
	ps, err := client.CoreV1().Pods(namespace).List(context.Background(), metav1.ListOptions{LabelSelector: "component=ws-manager"})
	if err != nil {
	...
	client.CoreV1().Pods(namespace).DeleteCollection(context.Background(), *metav1.NewDeleteOptions(30), metav1.ListOptions{LabelSelector: "component=workspace"})
	client.CoreV1().ConfigMaps(namespace).DeleteCollection(context.Background(), *metav1.NewDeleteOptions(30), metav1.ListOptions{LabelSelector: "component=workspace"})
